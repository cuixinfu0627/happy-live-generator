...
import com.happy.live.common.base.annotation.SysLog;
import com.happy.live.common.mvc.exception.RRException;
import com.happy.live.common.mvc.validator.Assert;
import com.happy.live.common.mvc.validator.ValidatorUtils;
...
import com.happy.live.passport.controller.oss.cloud.OSSFactory;
import com.happy.live.passport.entity.SysUserEntity;
import com.happy.live.passport.form.PasswordForm;
import com.happy.live.passport.service.SysUserRoleService;
...
public class SysUserController extends AbstractController {
	...
	@SysLog("修改用户")
	@PostMapping("/uploadAavatar")
	@RequiresPermissions("sys:user:update")
	public R userAavatar(@RequestParam("img") MultipartFile file) throws IOException {
		if (file.isEmpty()) {
		...
		String httpUrl = OSSFactory.build(null).uploadSuffix(file.getBytes(), suffix);
		String filePath = OSSFactory.build(null).getFilePath(httpUrl) ;

		SysUserEntity user = new SysUserEntity();
		user.setUserId(getUserId());
		user.setAvatar(filePath);
		sysUserService.uploadAavatar(user);
