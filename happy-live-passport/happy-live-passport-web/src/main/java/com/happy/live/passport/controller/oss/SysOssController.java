...
import com.happy.live.passport.controller.oss.cloud.CloudStorageConfig;
...
import com.happy.live.passport.service.SysOssService;
...
public class SysOssController {
	...
	public R saveConfig(@RequestBody CloudStorageConfig config){
		...
		if(config.getType() == Constant.CloudService.QINIU.getValue()){
			...
			//校验腾讯云数据
			ValidatorUtils.validateEntity(config, VsftpGroup.class);
		}
