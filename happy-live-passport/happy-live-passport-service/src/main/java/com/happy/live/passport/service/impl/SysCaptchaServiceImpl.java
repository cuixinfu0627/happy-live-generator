...
import com.happy.live.passport.dao.SysCaptchaDao;
import com.happy.live.passport.entity.SysCaptchaEntity;
...
public class SysCaptchaServiceImpl extends ServiceImpl<SysCaptchaDao, SysCaptchaEntity> implements SysCaptchaService {
    ...
    public BufferedImage getCaptcha(String uuid) {
        ...
        //5分钟后过期
        captchaEntity.setExpireTime(DateHandler.addDateMinutes(new Date(), 5));
